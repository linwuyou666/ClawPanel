...
> [!NOTE]
> **最新发布** — `ClawPanel Pro v5.5.0` 与 `ClawPanel Lite v0.3.5` 已发布；本次重点增强 Hermes 平台管理与面板设置体验，补齐 Lite 数据持久化升级策略，并修复 panel-chat / OpenClaw 运行时兼容问题。详情见 [changelogs/v5.5.0.md](changelogs/v5.5.0.md) 与 [changelogs/lite-v0.3.5.md](changelogs/lite-v0.3.5.md)。
